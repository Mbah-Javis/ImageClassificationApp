package com.mbahjavis.imageclassification
...
class MainActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    private fun getTopLabels(inferenceOutput: Array<ByteArray>): List<String> {
        ...
        return labelList.mapIndexed { idx, label ->
            ...
            // Sort the results in decreasing order of confidence and return only top 1.
    ...
    companion object {
        ...
        private const val REMOTE_MODEL_NAME = "mobilenetv1_for_android"
